...
BRNO,
TIPSEQ,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(ISDT), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(ISDT))='0' THEN NULL ELSE ISDT END) AS ISDT,
CKNO,
CKDG,
AMT,
SNDFG,
