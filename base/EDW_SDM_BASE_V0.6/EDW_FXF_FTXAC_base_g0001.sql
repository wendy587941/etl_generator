...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'MCHKDG' AS DATA_CHK_COL,
MCHKDG AS DATA_VAL,
SDG.UFN_NUMCHECK(MCHKDG) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0';
...
MCHKDG,
REMARK,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(KINDAY), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(KINDAY))='0' THEN NULL ELSE KINDAY END) AS KINDAY,
CURRENT_TIMESTAMP,
