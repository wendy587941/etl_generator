-- SQL for table: EDW_ELN_CRCUSTRELLOANDTLBR
/* CHECK_DATA */
...
'AVLBLN' AS DATA_CHK_COL,
AVLBLN AS DATA_VAL,
SDG.UFN_NUMCHECK(AVLBLN) AS CHECK_RESULT
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'SUMACTBAL' AS DATA_CHK_COL,
SUMACTBAL AS DATA_VAL,
SDG.UFN_NUMCHECK(SUMACTBAL) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0';
