...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'CHANGEDATE' AS DATA_CHK_COL,
CHANGEDATE AS DATA_VAL,
SDG.UFN_NULLCHECK_DATE(CHANGEDATE) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'DEPID' AS DATA_CHK_COL,
DEPID AS DATA_VAL,
SDG.UFN_NULLCHECK_VAR(DEPID) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'DEPCOUNT' AS DATA_CHK_COL,
DEPCOUNT AS DATA_VAL,
SDG.UFN_NULLCHECK_NUM(DEPCOUNT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'ADDCOUNT' AS DATA_CHK_COL,
ADDCOUNT AS DATA_VAL,
SDG.UFN_NULLCHECK_NUM(ADDCOUNT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'DELCOUNT' AS DATA_CHK_COL,
DELCOUNT AS DATA_VAL,
SDG.UFN_NULLCHECK_NUM(DELCOUNT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'null_err' AS DATA_CHK_TP,
'ALLDEPCOUNT' AS DATA_CHK_COL,
ALLDEPCOUNT AS DATA_VAL,
SDG.UFN_NULLCHECK_NUM(ALLDEPCOUNT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0';
...
SELECT
ID,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(CHANGEDATE), '')='' THEN '0001-01-01' WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(CHANGEDATE))='0' THEN '0001-01-01' ELSE CHANGEDATE END) AS CHANGEDATE,
DEPID,
DEPCOUNT,
ADDCOUNT,
DELCOUNT,
