...
'RISK_AMT' AS DATA_CHK_COL,
RISK_AMT AS DATA_VAL,
SDG.UFN_NUMCHECK(RISK_AMT) AS CHECK_RESULT
...
'ATC' AS DATA_CHK_COL,
ATC AS DATA_VAL,
SDG.UFN_NUMCHECK(ATC) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'PREV_ATC' AS DATA_CHK_COL,
PREV_ATC AS DATA_VAL,
SDG.UFN_NUMCHECK(PREV_ATC) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
