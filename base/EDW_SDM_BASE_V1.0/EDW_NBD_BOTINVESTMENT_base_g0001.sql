-- SQL for table: EDW_NBD_BOTINVESTMENT
/* CHECK_DATA */
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'BANK_TRADE_FLAG' AS DATA_CHK_COL,
BANK_TRADE_FLAG AS DATA_VAL,
SDG.UFN_NUMCHECK(BANK_TRADE_FLAG) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'LONG_SHORT_FLAG' AS DATA_CHK_COL,
LONG_SHORT_FLAG AS DATA_VAL,
SDG.UFN_NUMCHECK(LONG_SHORT_FLAG) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'CUR_PAR_BAL' AS DATA_CHK_COL,
CUR_PAR_BAL AS DATA_VAL,
SDG.UFN_NUMCHECK(CUR_PAR_BAL) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'ORG_TERM' AS DATA_CHK_COL,
ORG_TERM AS DATA_VAL,
SDG.UFN_NUMCHECK(ORG_TERM) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'DEFERRED_CUR_BAL' AS DATA_CHK_COL,
DEFERRED_CUR_BAL AS DATA_VAL,
SDG.UFN_NUMCHECK(DEFERRED_CUR_BAL) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'AMRT_TERM' AS DATA_CHK_COL,
AMRT_TERM AS DATA_VAL,
SDG.UFN_NUMCHECK(AMRT_TERM) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'RATE_CAP_LIFE' AS DATA_CHK_COL,
RATE_CAP_LIFE AS DATA_VAL,
SDG.UFN_NUMCHECK(RATE_CAP_LIFE) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'RATE_FLOOR_LIFE' AS DATA_CHK_COL,
RATE_FLOOR_LIFE AS DATA_VAL,
SDG.UFN_NUMCHECK(RATE_FLOOR_LIFE) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'RATE_SET_LAG' AS DATA_CHK_COL,
RATE_SET_LAG AS DATA_VAL,
SDG.UFN_NUMCHECK(RATE_SET_LAG) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'COMPOUND_BASIS_CD' AS DATA_CHK_COL,
COMPOUND_BASIS_CD AS DATA_VAL,
SDG.UFN_NUMCHECK(COMPOUND_BASIS_CD) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'YTM_BOT' AS DATA_CHK_COL,
YTM_BOT AS DATA_VAL,
SDG.UFN_NUMCHECK(YTM_BOT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0';
