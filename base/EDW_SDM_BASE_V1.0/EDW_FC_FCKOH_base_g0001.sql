...
RQSNO,
RQENO,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(RQDAY), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(RQDAY))='0' THEN NULL ELSE RQDAY END) AS RQDAY,
CKSTA,
