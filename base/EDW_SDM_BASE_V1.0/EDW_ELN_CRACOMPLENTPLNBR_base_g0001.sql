-- SQL for table: EDW_ELN_CRACOMPLENTPLNBR
/* CHECK_DATA */
...
'LENTP_RATIO' AS DATA_CHK_COL,
LENTP_RATIO AS DATA_VAL,
SDG.UFN_NUMCHECK(LENTP_RATIO) AS CHECK_RESULT
...
CRRPTNO,
QRYIDBAN,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(LREL_DATE), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(LREL_DATE))='0' THEN NULL ELSE LREL_DATE END) AS LREL_DATE,
LENTP_DEPART,
LENTP_PID,
LENTP_TBID,
LENTP_ENTPNO,
