-- SQL for table: EDW_TRTS_DATRA202
/* CHECK_DATA */
...
'WA20208' AS DATA_CHK_COL,
WA20208 AS DATA_VAL,
SDG.UFN_NUMCHECK(WA20208) AS CHECK_RESULT
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'WA20209' AS DATA_CHK_COL,
WA20209 AS DATA_VAL,
SDG.UFN_NUMCHECK(WA20209) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'WA20210' AS DATA_CHK_COL,
WA20210 AS DATA_VAL,
SDG.UFN_NUMCHECK(WA20210) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0';
...
WA20203,
WA20204,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(WA20206)||' '||TRIM(WA20205), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(WA20206)||' '||TRIM(WA20205))='0' THEN NULL ELSE TRIM(WA20206)||' '||TRIM(WA20205) END) AS WA20205,
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(WA20206), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(WA20206))='0' THEN NULL ELSE WA20206 END) AS WA20206,
WA20207,
WA20208,
WA20209,
WA20210,
