...
'LEVEL_ID' AS DATA_CHK_COL,
LEVEL_ID AS DATA_VAL,
SDG.UFN_NUMCHECK(LEVEL_ID) AS CHECK_RESULT
...
SELECT
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(DATA_YYYYMM), '')='' THEN '0001-01-01' WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(DATA_YYYYMM))='0' THEN '0001-01-01' ELSE DATA_YYYYMM END) AS DATA_YYYYMM,
