...
'AO_TENURE' AS DATA_CHK_COL,
AO_TENURE AS DATA_VAL,
SDG.UFN_NUMCHECK(AO_TENURE) AS CHECK_RESULT
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'AO_TENURE_M' AS DATA_CHK_COL,
AO_TENURE_M AS DATA_VAL,
SDG.UFN_NUMCHECK(AO_TENURE_M) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'AO_TENURE_Q' AS DATA_CHK_COL,
AO_TENURE_Q AS DATA_VAL,
SDG.UFN_NUMCHECK(AO_TENURE_Q) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
