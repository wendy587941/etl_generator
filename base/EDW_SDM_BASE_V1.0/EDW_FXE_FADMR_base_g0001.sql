...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'LCAMT' AS DATA_CHK_COL,
LCAMT AS DATA_VAL,
SDG.UFN_NUMCHECK(LCAMT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
CAST(ROWID AS VARCHAR2(100)) AS CHK_ID,
'num_err' AS DATA_CHK_TP,
'LTCNT' AS DATA_CHK_COL,
LTCNT AS DATA_VAL,
SDG.UFN_NUMCHECK(LTCNT) AS CHECK_RESULT
FROM ${SOURCE_TABLE_OWNER}.${SOURCE_TABLE} 
WHERE DATA_EXCH_DATE = TO_DATE('${TXDATE}', 'YYYY-MM-DD')
) S1
WHERE S1.CHECK_RESULT = '0'
...
SDG.UFN_NORM_DATE(CASE WHEN NVL(TRIM(CTXDAY), '')='' THEN NULL WHEN SDG.UFN_ADDATECHECK_DATE(TRIM(CTXDAY))='0' THEN NULL ELSE CTXDAY END) AS CTXDAY,
